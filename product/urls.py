...
urlpatterns = [
    ...
    path("products/by-brand/<int:pk>/",
         ProductsByBrand.as_view(), name="products-by-brand"),
    ...
    path("top-selling-products/", TopSellingProducts.as_view(),
         name="top_selling_products"),
    path("popular-products/", PopularProductsView.as_view(),
         name="popular-products"),
    path("similar-products/", SimilarProductsView.as_view(),
         name="similar-products"),

    # Cart URLs
    path("cart/", CartView.as_view(), name="cart-view"),
    path("cart/item/<int:pk>/", CartProductsDetail.as_view(),
         name="cart-item-detail"),

    # Favorite List URLs
    path("favoritelist/", FavoriteListView.as_view(), name="favorite-list"),
    path("favoritelist/remove/", RemoveFromFavoriteList.as_view(),
         name="favorite-list-remove"),

    # Rating and Review for Brand URLs
    path("rating/brand/", RatingBrandListCreateView.as_view(),
         name="brand-rating-list-create"),
    path("rating/brand/<int:brand_id>/",
         RatingBrandEditDeleteView.as_view(), name="brand-rating-edit-delete"),
    path("review/brand/", ReviewBrandListCreateView.as_view(),
         name="brand-review-list-create"),
    path("review/brand/<int:brand_id>/",
         ReviewBrandEditDeleteView.as_view(), name="brand-review-edit-delete"),
    ...
    path("review/<int:product_id>/",
         ReviewEditDelete.as_view(), name="review-edit-delete"),

    # Coupon URLs
    path("coupons/", CouponListCreateView.as_view(), name="coupon-list-create"),
    path("coupons/<int:pk>/", CouponRetrieveUpdateDestroyView.as_view(),
         name="coupon-detail"),
    ...
    path("questions/<int:question_id>/answers/",
         AnswerList.as_view(), name="answer-list"),
